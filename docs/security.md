...
| Creator's own backend / local CLI | Backend verifies with public keys; local CLI has build upload/status and separately scoped listing:write and token:configure mutations |
