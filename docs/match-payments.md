...
4. Keep the credential in private server configuration. Never put it in browser code, the downloaded publishing file, Git, chat or logs. Keep `@spawndotfamily/sdk/server` out of browser bundles.
